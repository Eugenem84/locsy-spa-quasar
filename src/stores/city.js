...
export const useCityStore = defineStore('city', () => {
  ...
  const cities = ref([
    { label: 'Москва', value: 'moscow', coords: [55.751244, 37.618423] },
    { label: 'Санкт-Петербург', value: 'spb', coords: [59.9375, 30.3086]},
    { label: 'Новосибирск', value: 'nsk', coords:  [55.0415, 82.9346]}
